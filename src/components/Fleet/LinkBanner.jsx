...
const LinkBanner = ({ image, title, linkTo, titleBottom = true, changeTitleSize = true }) => {
  return (
    <Link
      to={linkTo}
    ...
    >
      {/* Background Image */}
      <div
        className="absolute inset-0 bg-cover bg-bottom transition-transform duration-500 ease-out group-hover:scale-110"
