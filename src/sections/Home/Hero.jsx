...
const Hero = () => {
  return (
    <section className=' h-[calc(100vh-136px)] md:h-[calc(100vh-80px)] bg-primary flex flex-col'> 
      ...
      <div className='flex-grow flex flex-col justify-evenly text-justify'>
        <h1 className='text-white font-redRose text-3xl text-center  lg:text-4xl'>EXPLORE THE ADRIATIC</h1>
